...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
    {German Aerospace Center (DLR)}{Oct 2024 - Sep 2025}
    ...
    \resumeItemListStart
        ...
        \resumeItem{Collaborated within an \textbf{Agile team} to deliver data-driven results, culminating to the successful completion of a \textbf{co-authored} conference paper (IAC 2025) detailing the novel application.}
...
\section{Education}
    ...
    {Bachelor of Science in Astronomy}{Padua, Italy}
    \resumeItemListStart
